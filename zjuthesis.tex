...
\documentclass[
    ...
    % Title
    Title           = 面向RISC-V处理器的侧信道漏洞形式化检测框架,
    TitleEng        = {{A Detection Framework for Side-Channel Vulnerabilities Targeting RISC-V Processors Using Formal Method}}
]{zjuthesis}
